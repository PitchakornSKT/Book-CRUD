...
## Setup
```bash
npx create-expo-app book-crud --template blank-typescript
cd book-crud
...
git init
git add .
git commit -m "feat: Book CRUD app in TypeScript"
git remote add origin https://github.com/<your-username>/book-crud-expo.git
git branch -M main
...
## Submit
- Make repo public
- Share GitHub link in Classroom
*/